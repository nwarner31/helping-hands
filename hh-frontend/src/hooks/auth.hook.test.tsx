...
jest.mock("../utility/validation/utility.validation", () => ({
    mapZodErrorsFromSchema: jest.fn(),
}));
...
import { mapZodErrorsFromSchema } from "../utility/validation/utility.validation";
...
const mockedMapErrors = mapZodErrorsFromSchema as jest.MockedFunction<typeof mapZodErrorsFromSchema>;
