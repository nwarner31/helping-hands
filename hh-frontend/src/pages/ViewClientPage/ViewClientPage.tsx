...
const ViewClientPage = () => {
    ...
    const [clientData, setClientData] = useState<Client>(() => location.state?.client ?? emptyClient);
    ...
    // {clientData.house.clients ? clientData.house.clients.length : 0}
                    ...
                    <>
                        ...
                        <Accordion id="house-info" header="House Info" variant="secondary" className="font-header mb-4 font-semibold">
                            <div className="grid grid-cols-2 font-body">
                                ...
                                <div >Clients:</div><div>{clientData.house.numClients}/{clientData.house.maxClients}</div>
                                <div >Roommates:</div>
                                <div >
