...
const AdminDashboard = () => {
    return (
        <div >
            <LinkButton id="client" to="/view-clients" className="flex flex-col items-center text-center mb-4" variant="secondary">
                <ClientIcon className="m-auto fill-current w-25 p-0" />
                <div>Manage Clients</div>
            </LinkButton>
            <LinkButton id="house" to="/view-houses" variant="primary" className="flex flex-col items-center text-center">
