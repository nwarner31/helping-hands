    ...
    return (
        <div className="my-2">
            <div className="grid grid-cols-[auto_1fr_auto] gap-x-2 px-1 sm:grid-cols-[auto_2fr_3fr_auto]">
                ...
                <LinkButton  to={`/edit-event/${event.id}`} className="row-span-4 col-start-3 sm:col-start-4">Edit</LinkButton>
                    ...
                    <List>
                        {conflicts.map((conflict, index) => (
                            <ListItem id={`${conflict.id}-${index}`} key={`${conflict.id}-${index}`}>
                                <div className="grid grid-cols-[2fr_1fr_auto] sm:grid-cols-[2fr_3fr_auto] gap-x-2 my-2 mx-1">
                                    ...
                                    <LinkButton  to={`/edit-event/${conflict.id}`} className="row-span-3 sm:row-span-2 col-start-3 row-start-1" >Edit</LinkButton>
                                </div>
                            </ListItem>
                        ))}
                    </List>
