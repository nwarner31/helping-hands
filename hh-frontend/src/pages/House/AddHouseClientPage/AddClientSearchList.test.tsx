...
jest.mock("../../../utility/ApiService", () => ({
    patch: jest.fn(() => Promise.resolve( { message: "client added to house", data: { id: "123" }})),
   }));
...
describe("AddClientSearchList", () => {
    ...
    it("calls API and shows toast on successful add", async () => {
        ...
        await waitFor(() => {
            ...
            expect(mockToastSuccess).toHaveBeenCalledWith("Client added to house successfully", {autoClose: 1500, position: "top-right"});
        });
    });
});
