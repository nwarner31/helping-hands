...
export type ButtonVariant = "primary-light" | "primary" | "primary-dark" | "secondary" | "danger" | "success" | "accent" | "ghost-primary" | "ghost-secondary";
...
const variantClasses: Record<ButtonVariant, string> = {
    ...
    secondary: "bg-secondary-500 text-white hover:bg-white hover:text-secondary-500 border-secondary-500 focus:outline-outline-secondary-500",
    ...
    "ghost-secondary": "bg-transparent text-secondary-500 hover:bg-secondary-300 hover:text-secondary-900 border-secondary-500  focus:outline-outline-secondary-500"
};
